...
if {$make_assignments} {
	...
	set_location_assignment PIN_D9 -to ft_data[2]
	set_location_assignment PIN_E9 -to ft_data[3]
	set_location_assignment PIN_A9 -to ft_data[4]
	set_location_assignment PIN_B9 -to ft_data[5]
	set_location_assignment PIN_A8 -to ft_data[6]
	set_location_assignment PIN_B8 -to ft_data[7]
	set_location_assignment PIN_D8 -to ft_rxfn
	set_location_assignment PIN_C8 -to ft_txen
	set_location_assignment PIN_F7 -to ft_siwu
	set_location_assignment PIN_F6 -to ft_oen
	set_location_assignment PIN_C6 -to sync_in
	set_location_assignment PIN_A6 -to sync_out
	set_location_assignment PIN_D4 -to trans[0]
	set_location_assignment PIN_E5 -to trans[1]
	set_location_assignment PIN_F5 -to trans[2]
	set_location_assignment PIN_B1 -to trans[3]
